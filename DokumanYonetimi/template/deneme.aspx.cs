    ...
    public partial class deneme : System.Web.UI.Page
    {
        ...
        public bool ShowDocument(int bildiriId, string type)
        {
            ...
            try
            {
                ...
                string pdfdata= "pdfgoster('" + base64String + "')";
                base64.Text = base64String;
                //Page.ClientScript.RegisterStartupScript(this.GetType(), "PageUp", @"<script type='text/javascript'> setTimeout(function(){ pdfgoster('"+base64String+"') }, 3000);</script>");
